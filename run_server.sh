...
export CUDA_VISIBLE_DEVICES="0,1" # Correct filling the GPU indexs you want to use

MODEL_FOLDER_PATH="/home/data1/meta-llama/Meta-Llama-3-70B-Instruct-2shards" # model path
